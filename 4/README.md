...
==Photographs were taken of objects in absolute darkness=={description="This may be related to proposed experiments for his new West Orange laboratory. See <i>TAEB</i> 8: 850, 873; <i>TAEB</i> 9: 16."} by means of <del>heat waves</del> radiant heat being those <del>lines</del> waves <del>which wer</del> beyond the red end of the visible spectrum small lenses of Rock salt being used in the Camera. The plate is sensitized by <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;see notes watts Dic&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</u> above Radiant Light reflected from an object produces more or less decomposition of a silver salt and an image. But in this case Raidiant heat absolutely invisible performs the same function— The Chemicals alone being different
