...
Photographs were taken of objects in absolute darkness by means of <del>heat waves</del> radiant heat being those <del>lines</del> waves <del>which wer</del> beyond the red end of the visible spectrum small lenses of Rock salt being used in the Camera. The plate is sensitized by ______. see notes watts Dic above Radiant Light reflected fron an object produces more or less decomposition of a silver salt and an image. But in this case Raidiant heat absolutely invisible performs the same function— The Chemicals alone being different
