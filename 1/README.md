...
2 <span style="color:red">*X*</span> ==Space filled lines force. Sun magnet.=={description="In April 1886, while on his honeymoon stay at Fort Myers Edison speculated in his notebooks that gravitation is an electromagnetic phenomenon, and that electromagnetism could explain the workings of the solar system. See https://taep.s.gy/elec-grav"} break in surface of equatorial regions suns forms arc prominences matter melted by excess temperature due to difference potential at breaks— max <del>d</del> difference Emf at equatorial regions. Tails comets repelled by magnet lines Tail being an electric stress in the ==ether=={description="Edison’s earliest specific reference to the ether appears in an 1888 notebook, but his etheric force experiments clearly referenced the idea. The ether was generally accepted as a necessary idea by the nineteenth century’s best scientific minds, though used with varying degrees of skepticism and literal-mindedness, to explain physical actions (such as magnetism or the transmission of light) across space without benefit of air or other perceptible conducting medium. See https://taep.s.gy/ether"} **OK**
